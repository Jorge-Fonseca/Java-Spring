...
public class Chamado implements Serializable {
	...
	private LocalDate dataAbertuta = LocalDate.now();
	@JsonFormat(pattern = "dd/MM/yyyy")
	...
	public LocalDate getDataAbertuta() {
		return dataAbertuta;
	}
	public void setDataAbertuta(LocalDate dataAbertuta) {
		this.dataAbertuta = dataAbertuta;
	}
